...
@Autonomous(name="RightSideAuto_4Specimen_gw_test_Push", group="org.firstinspires.ftc.teamcode.Auto")
@Config
public class RightAuto_4Specimen_Push extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence trajSeq1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.1)
                .lineToLinearHeading(new Pose2d(highbar_x_coordinate, highbar_y_coordinate-16, Math.toRadians(-90)))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    drive.setDrivePower(new Pose2d(0, 0, 0));
                })
                ...
                .splineToConstantHeading(new Vector2d(58,-8),Math.toRadians(-90))
