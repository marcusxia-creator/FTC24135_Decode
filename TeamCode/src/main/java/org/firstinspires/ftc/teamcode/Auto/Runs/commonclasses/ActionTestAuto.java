        ...
        if (opModeIsActive()) {
            Actions.runBlocking(
                new SequentialAction(
                    turret.TurretRun(65),
                    intake.IntakeRun(8),
                    shooter.ShootFarZone(FarShotPower1,1.5, 0,targetGreen),
                    shooter.ShooterOff(),
                    intake.IntakeRun(8),
                    shooter.ShootFarZone(FarShotPower1,1.5, 1,targetGreen),
                    shooter.ShooterOff(),
                    intake.IntakeRun(8),
                    shooter.ShootFarZone(FarShotPower1,1.5, 2,targetGreen),
                    shooter.ShooterOff()
                )
            );
        }
