...
@Autonomous(name = "AllianceBlueSideFarAuto", group = "Autonomous")
public class AllianceBlueSideFarAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action intakeSet3Drive1Action = IntakeSet3Drive1.build();
        Action intakeSet3Drive2Action = IntakeSet3Drive2.build();
