...
public class RightSideAuto_3Specimen_KDay extends LinearOpMode {
    ...
    public static double first_sample_point_1_Y = -45; //heading = 45
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.depositLeftArmServo.setPosition(RobotActionConfig.deposit_Arm_Hook+0.2);
        robot.depositRightArmServo.setPosition(RobotActionConfig.deposit_Arm_Hook+0.2);
        sleep(1000);
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0,()->{
                    Slides_Move(RobotActionConfig.deposit_Slide_Rear_Highbar_Pos,RobotActionConfig.deposit_Slide_UpLiftPower);
                    Deposit_Score();
                })
                .waitSeconds(0.3)
                //drive to bar
    ...
    private void Deposit_Score(){
        robot.depositLeftArmServo.setPosition(RobotActionConfig.deposit_Arm_Rear_Hook);
        robot.depositRightArmServo.setPosition(RobotActionConfig.deposit_Arm_Rear_Hook);
        robot.depositWristServo.setPosition(RobotActionConfig.deposit_Wrist_Rear_Hook);
        robot.depositClawServo.setPosition(RobotActionConfig.deposit_Claw_Close);
    }
    private void Deposit_Transfer(){
        robot.depositLeftArmServo.setPosition(RobotActionConfig.deposit_Arm_Transfer);
        robot.depositRightArmServo.setPosition(RobotActionConfig.deposit_Arm_Transfer);
        robot.depositWristServo.setPosition(RobotActionConfig.deposit_Wrist_Transfer);
        robot.depositClawServo.setPosition(RobotActionConfig.deposit_Claw_Open);
    }
    private void Intake_Extend (){
        robot.intakeTurretServo.setPosition(RobotActionConfig.intake_Turret_Mid);
        robot.intakeArmServo.setPosition(RobotActionConfig.intake_Arm_Idle);
        robot.intakeWristServo.setPosition(RobotActionConfig.intake_Wrist_Grab);
        robot.intakeClawServo.setPosition(RobotActionConfig.intake_Claw_Open);
    }
    private void Intake_Transfer (){
        robot.intakeTurretServo.setPosition(RobotActionConfig.intake_Turret_Mid);
        robot.intakeArmServo.setPosition(RobotActionConfig.intake_Arm_Transfer);
        robot.intakeWristServo.setPosition(RobotActionConfig.intake_Wrist_Transfer);
    }
