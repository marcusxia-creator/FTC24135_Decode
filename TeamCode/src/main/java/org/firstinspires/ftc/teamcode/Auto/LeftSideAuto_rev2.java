...
public class LeftSideAuto_rev2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0,()->{robot.depositArmServo.setPosition(RobotActionConfig.deposit_Arm_Dump_Prep);})
                .UNSTABLE_addTemporalMarkerOffset(0,()->{robot.depositWristServo.setPosition(RobotActionConfig.deposit_Wrist_Flat_Pos);})
                ...
                .waitSeconds(1.8)                                                                                               // wait time to lower slides.
                /** move to 1st sample*/
                ...
                .UNSTABLE_addTemporalMarkerOffset(1.0,()->{robot.depositClawServo.setPosition(RobotActionConfig.deposit_Claw_Close);})
                .UNSTABLE_addTemporalMarkerOffset(1.2,()->{robot.intakeClawServo.setPosition(RobotActionConfig.intake_Claw_Open);})
