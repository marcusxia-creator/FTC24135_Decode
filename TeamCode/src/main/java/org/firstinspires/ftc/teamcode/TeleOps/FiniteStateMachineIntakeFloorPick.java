 ...
 */
public class FiniteStateMachineIntakeFloorPick {
    ...
    FiniteStateMachineDepositFloorPick.LIFTSTATE depositArmState;

    //Constructor
    public FiniteStateMachineIntakeFloorPick(RobotHardware robot, GamepadEx gamepad_1, GamepadEx gamepad_2, FiniteStateMachineDepositFloorPick depositArmDrive) {
    ...
    public void IntakeArmLoop() {
        ...
        switch (intakeState) {
            ...
            case INTAKE_TRANS:
                ...
                depositArmDrive.SetDepositstate(FiniteStateMachineDepositFloorPick.LIFTSTATE.LIFT_START);
                ...
                if (depositArmState == FiniteStateMachineDepositFloorPick.LIFTSTATE.LIFT_START &&
                        intakeTimer.seconds() > RobotActionConfig.transferTime) {
                    depositArmDrive.SetDepositClawState(FiniteStateMachineDepositFloorPick.DEPOSITCLAWSTATE.CLOSE);
                }
