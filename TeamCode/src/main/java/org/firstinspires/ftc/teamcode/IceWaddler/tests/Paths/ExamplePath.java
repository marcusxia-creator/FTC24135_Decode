...
public class ExamplePath {
    ...
    public static List<Action> ShootPath = new ArrayList<>(Arrays.asList(
            new Action(new Pose2D(METER, decelX, row1Y, AngleUnit.DEGREES, 180),   fastSpeed,  false,  0.1, new String[]{}),
            new Action(new Pose2D(METER, Ball1X, row1Y, AngleUnit.DEGREES, 180),   slowSpeed,  true,   stopTolerance,new String[]{}),
            new Action(HOLDTYPE.POS, intakeTime, new String[]{"Intake"}),
            new Action(new Pose2D(METER, Ball2X, row1Y, AngleUnit.DEGREES, 180),   slowSpeed,  true,   stopTolerance,new String[]{}),
            new Action(HOLDTYPE.POS, intakeTime, new String[]{"Intake"}),
            new Action(new Pose2D(METER, Ball3X, row1Y, AngleUnit.DEGREES, 180),   slowSpeed,  true,   stopTolerance,new String[]{}),
            new Action(HOLDTYPE.POS, intakeTime, new String[]{"Intake"}),
            new Action(new Pose2D(METER, decelX, row1Y, AngleUnit.DEGREES, 180),   fastSpeed,  false,  0.1,new String[]{}),
            new Action(shootingPose,                                                       fastSpeed,  true,  stopTolerance,new String[]{}),
            new Action(HOLDTYPE.POS, shootTime, new String[]{"Shooting"}),
            new Action(init,                                                               fastSpeed,  true,   stopTolerance,new String[]{})
    ));
