...
public class RobotActionConfig {
	...
	public static double intake_Rotation_Floor_Push     = 0.15;
	...
	public static int slideTickThreshold                = 50;                                           // vertical slide threshold value to determine if the slide is at position
	public static double Move_Distance                  = 20;                                            //20cm forward - move forward after dump sample

	// Vision intake alignment tuning
	public static boolean visionIntakeEnabled           = true;
	public static double visionTurretKp                 = 0.12;    // servo step per unit normalized error
	public static double visionMaxTurretStep            = 0.05;    // max step per cycle
	public static double visionTurretDeadband           = 0.05;    // normalized error deadband to ignore
	public static double visionCompleteDeadband         = 0.08;    // stricter center to complete pickup
	public static double visionPickupArea               = 1200;    // area threshold to consider close enough to grab
	public static double visionMaxAlignTime             = 1.5;     // seconds before timeout fallback
	public static double visionTargetArea               = 2500;    // area considered very close (for mapping)
	public static double visionMinAreaForMapping        = 200;     // minimum area to start retract mapping
}