...
public class RightSideAuto extends LinearOpMode {
    ...
    public static double highbar_x_coordinate = 7.5;
    public static double highbar_y_coordinate = -24;
    public static double highbar_prep_x_coordinate = 7.5;
    public static double highbar_prep_y_coordinate = -36;
    ...
    public static double fifth_move_y_coordinate = -58;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(7.5, -64, 0);
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(first_move_x_coordinate, first_move_y_coordinate, Math.toRadians(0)))
                .lineToLinearHeading(new Pose2d(second_move_x_coordinate, second_move_y_coordinate, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(third_move_x_coordinate, third_move_y_coordinate, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(fourth_move_x_coordinate, fourth_move_y_coordinate, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(fifth_move_x_coordinate, fifth_move_y_coordinate, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(specimen_pickup_x_coordinate, specimen_pickup_y_coordinate, Math.toRadians(180)))
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(highbar_prep_x_coordinate, highbar_prep_y_coordinate, Math.toRadians(0)))
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(highbar_x_coordinate, highbar_y_coordinate, Math.toRadians(0)))
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(specimen_pickup_x_coordinate, specimen_pickup_y_coordinate, Math.toRadians(180)))
