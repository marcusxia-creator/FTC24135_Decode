...
public class RedSidePositions {
    ...
    public static double FarShotPower = 0.98;
    ...
    public static double CloseShootingPosition_X = -26;
    public static double CloseShootingPosition_Y = 20;
    public static double ShootingPosition_Heading = 90;
